        ...
        <section className="py-16 px-4 md:px-16 bg-white">
            <div className="container mx-auto text-center mb-12">
                ...
                <p className="text-[#7F8499] text-[16px] md:text-[18px] mb-8">
                    We offer professional services with expertise and precision to meet all your cooling and heating needs. <br/>
                    Our dedicated team ensures efficient solutions, keeping your home comfortable and running smoothly.
                </p>
            </div>
